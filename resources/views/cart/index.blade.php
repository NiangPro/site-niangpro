...
@section('content')
        ...
        <div class="px-4 px-lg-0">
            <div class="pb-5">
                                ...
                                <tbody>
                                    @foreach (Cart::content() as $product)
                                        <tr>
                                            ...
                                            <td class="border-0 align-middle"><strong>{{ getPrice($product->model->price) }}</strong></td>
                ...
                <div class="row py-5 p-4 bg-white rounded shadow-sm">
                    ...
                    {{-- End Code Coupon --}}
                    {{-- Caisse --}}
                        <div class="col-lg-5 bg-white rounded shadow-sm ml-auto">
    ...
    @else
        <div class="container col-md-8">
            <h5 class="alert alert-success">Votre panier est vide pour le moment !</h5>
            <p>
            Mais vous pouvez visiter la <a href="{{ route('product.index') }}">boutique</a> pour faire votre shopping.
            </p>
        </div>
    @endif
@endsection
